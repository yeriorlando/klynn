...
const VALID_COLUMNS: Record<string, Set<string>> = {
  ...
  ordenes: new Set([
    ...
    "nota_credito_ncf",
    "nota_credito_id",
    "nota_credito_anula_totalmente",
    "nota_credito_qr",
    "nota_credito_codigo_seguridad",
    "nota_credito_fecha_firma",
    "nota_credito_fecha_emision",
    "nota_credito_estado",
    "nota_credito_pdf_url",
    "nota_credito_xml_url",
    "ecf_qr",
    "ecf_security_code",
    "ecf_signature_date",
    ...
    "nota_debito_monto",
    "nota_debito_qr",
    "nota_debito_codigo_seguridad",
    "nota_debito_fecha_firma",
    "nota_debito_fecha_emision",
    "nota_debito_estado",
    "nota_debito_pdf_url",
    "nota_debito_xml_url",
    "ncf_vencimiento",
