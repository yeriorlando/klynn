...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full grid lg:grid-cols-12 bg-white font-sans antialiased selection:bg-[#F0B900] selection:text-slate-950">
      ...
      <div className="relative hidden lg:col-span-6 xl:col-span-6 lg:flex flex-col justify-between p-8 xl:p-12 overflow-hidden bg-[#1B4B73] text-white border-r border-slate-200/20 h-full">
        ...
        <div className="relative z-10 my-auto max-w-lg space-y-6 py-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      {/* PANEL DERECHO: Formulario Blanco, Nítido y Elegante (50% Ancho) */}
      <div className="lg:col-span-6 xl:col-span-6 flex items-center justify-center p-6 sm:p-10 xl:p-14 bg-white h-full overflow-y-auto">
        <div className="w-full max-w-md mx-auto space-y-6">
          ...
          {matchingAccounts.length > 0 ? (
            ...
            <div className="space-y-4 animate-in fade-in zoom-in-98 duration-200">
              <div className="rounded-xl bg-[#1B4B73]/5 border border-[#1B4B73]/15 p-3.5 text-left space-y-1">
                ...
                <p className="text-[11px] text-slate-600">
                  Tu correo <strong className="font-semibold text-slate-900">{email}</strong> tiene acceso a <strong className="font-semibold text-[#1B4B73]">{matchingAccounts.length} lavanderías</strong>. Selecciona a cuál deseas acceder:
                </p>
              </div>
              ...
              <div className="pt-2 space-y-2">
                ...
                <Button
                  ...
                  type="button"
                  variant="outline"
                  className="w-full h-10 bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200 font-semibold rounded-xl text-xs shadow-2xs flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
            ...
            <form
              onSubmit={onSubmit}
              className="space-y-4 animate-in fade-in zoom-in-98 duration-200"
            >
              {/* Campo Email */}
              ...
              <div className="space-y-1.5 text-left">
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#1B4B73] transition-colors cursor-pointer"
              ...
              {/* Mensaje de Error */}
              {error && (
                <div className="flex items-center gap-2 rounded-xl border border-rose-200 bg-rose-50/80 p-3 text-xs font-semibold text-rose-700 animate-in fade-in duration-200">
              ...
              <div className="pt-2">
                <div className="relative overflow-hidden rounded-2xl bg-slate-50 border border-slate-200/90 p-4 transition-all hover:border-[#1B4B73]/40 group shadow-2xs space-y-2.5">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-xs sm:text-sm font-bold text-slate-700">
                      ¿Tienes una invitación?
                    </span>
                    <span className="inline-flex items-center gap-1.5 text-xs font-black text-amber-700 bg-amber-50 px-2.5 py-0.5 rounded-full border border-amber-200/80">
                  ...
                  <Link 
                    to="/registro" 
                    className="w-full h-11 flex items-center justify-center gap-2 py-2 px-4 rounded-xl bg-white border border-slate-200 text-xs sm:text-sm font-black text-[#1B4B73] hover:bg-[#1B4B73] hover:text-white shadow-2xs transition-all duration-200 group/btn cursor-pointer"
                  >
